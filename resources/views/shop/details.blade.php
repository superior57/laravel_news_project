...
<div class="head p-3 px-md-5 text-end mb-50">
    <a href="{{ url('/shop') }}" class="btn">
        <img src="{{ asset('img/ico/close.svg') }}" alt="">
    </a>
</div>
        ...
        <div class="body container-md">
            <div class="row">
                <div class="col-md-6 pr-md-30">
                    <div class="item-img">
                        <img src="{{ asset('img/shop/detail1.png') }}" alt="">
                    </div>
                    <div class="item-img">
                        <img src="{{ asset('img/shop/detail2.png') }}" alt="">
                    </div>
                    <div class="item-img">
                        <img src="{{ asset('img/shop/detail1.png') }}" alt="">
                    </div>
                ...
                <div class="col-md-6 pl-md-30">
                    <div class="product mb-5">
                        <h5 class="name">G.IA T-Shirt unisex</h5>            
                        <span class="description">
                            Two color acrylic and gouache silk screen print on a unique piece of salvaged wood. 16X20 inches. Edition of 5. $150.00 each. These pieces are from the collection of collaborations made with Woodward Throwbacks, a Detroit based architectural salvage and design firm.    
                        </span>       
                    </div>     

                    {{-- size selector --}}
                    <div class="select-size mb-4">
                        <h5 class="mb-4">Select size*</h5>
                        <ul class="selectors">
                            <li class="active"><a href="#" class="select-item" data-size-id="xs">xs</a></li>    
                            <li><a href="#" class="select-item" data-size-id="s">S</a></li>    
                            <li><a href="#" class="select-item" data-size-id="m">M</a></li>    
                            <li><a href="#" class="select-item" data-size-id="l">L</a></li>    
                        </ul>   
                    </div>
                    {{-- End size selector  --}}
                    <div class="mb-4">
                        <h5 class="product-price">$79</h5>
                    </div>
